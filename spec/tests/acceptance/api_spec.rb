...
describe 'Test API routes' do
  ...
  #     TrailSmith::Service::AddProject.new.call(
  ...
  #     proj = TrailSmith::Representer::Project.new(
  #       TrailSmith::Representer::OpenStructWithLinks.new
  ...
  #     encoded_list = TrailSmith::Request::EncodedProjectList.to_encoded(list)
